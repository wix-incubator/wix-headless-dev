...
async function modeContinue(args) {
  ...
  emit("done", { mode: "continue", liveUrl, dashboardUrl: dashboardUrl(siteId), siteId, projectDir: dir });
}
...
async function modeNew(args) {
  ...
  emit("done", { mode: "new", liveUrl, dashboardUrl: dashboardUrl(siteId), siteId, projectDir });
}
